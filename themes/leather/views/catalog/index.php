                ...
                <?php foreach ($items as $item) {
                    ...
                    <div class="product_pd">
                        ...
                        <div class="product_price_1" align="center">
                            <div class="product_price_n center-block">促销价：<?php echo $item->currency . $item->price ?></div>
                            <br>
                            <div class="product_price_p center-block">一口价:<?php echo $item->currency . $item->price ?></div>
                            <br>
                            <div class="product_price_v center-block"><a href="<?php echo $itemUrl; ?>">详情点击</a></div>
                        </div>
                    </div>
                <?php } ?>
            </div>
